...
def create_dashboard() -> sd.Dashboard:
    ...
    page.add_text("""
    All plotting functions are pure functions that work on GraphData objects.
...
"""
    ...
    3. **Pure Functions**: All plot functions work on GraphData objects, so you have complete 
